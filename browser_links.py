...
def generate_links_based_on_website():
...
def get_broucher_user_prompt():
    ...
    system_instruction = (
        "You an assistant who analyze the content of several webpages from a company website and create a short broucher about the company which should look little funny and crispy"
    ...
    user_prompt = (f"You're looking at a company broucher called {website_title}, here is the relavent content of the website {website_content} use this information to build a short "
                   ...
                   f"make sure the output should be in Markdown format and response should be displayed in Japanese format")
    user_prompt += """
